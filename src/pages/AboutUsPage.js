...
const CardHeader = ({ children }) => (
  <div className="px-6 py-4 border-b border-grey-900">
    {children}
  </div>
)
  ...
  return (
    <div className="flex flex-col min-h-screen bg-grey-900">
      ...
      <main className="flex-grow">
        <div className="min-h-screen bg-white text-grey-900 p-8">
          <div className="max-w-6xl mx-auto">
            ...
            <button 
              className="text-grey-900 hover:text-blue-300 flex items-center mb-8"
              onClick={() => setShowFullDescription(!showFullDescription)}
            >
              {showFullDescription ? 'Show Less' : 'Learn More'} <span className="ml-1">→</span>
            </button>
            ...
            <h2 className="text-3xl font-bold mt-12 mb-6">Project Details</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="mt-12">
              <Card>
                ...
                <CardContent>
                  <img src="/src/assets/images/Eureka.png" alt="Eureka - Revolutionizing Geothermal Exploration" className="w-full mb-4" />
                  <CardDescription>
